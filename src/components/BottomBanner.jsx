...
export default function BottomBanner() {
  return (
    <div
      className="flex-col gap-9 bg-[50%] bg-cover justify-center text-center items-center p-[100px] mb-10 flex relative top-auto bottom-[0%] left-auto right-[0%] max-sm:p-[30px]"
      style={{
