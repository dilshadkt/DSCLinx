...
export default function Banner({ head, desc }) {
  return (
    <div
      ...
      style={{ backgroundImage: 'url("/b1.png")',width: "100%", height: "450px" }}
    >
      <h3 className="text-[50px] font-semibold tracking-[-1.56px] leading-[120.6%] w-full max-lg:text-[42px] max-md:text-[42px]  max-sm:text-[32px]">
        {head}
      </h3>
