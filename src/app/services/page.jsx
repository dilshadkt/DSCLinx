  ...
  return (
    <>
      ...
      <section className="container py-[70px] overflow-hidden max-lg:py-[100px] max-md:py-[80px] max-sm:py-[40px]">
        ...
        <h2 className="mb-[10px] ml-auto mr-auto text-[42px] tracking-[-1.8px] font-semibold leading-[115%] max-lg:text-center max-lg:mb-[10px] max-lg:ml-auto max-lg:mr-auto max-lg:text-[48px] max-md:mb-[8px] max-md:text-[36px] max-sm:text-[27px]">Discover The Variety Of Services We Offer</h2>
            <div>
